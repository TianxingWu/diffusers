...
pipe = StableVideoDiffusionPipeline.from_pretrained("stabilityai/stable-video-diffusion-img2vid", torch_dtype=torch.float16, variant="fp16", generator=generator)

pipe.to("cuda")

input_img_path = "/home/tianxing001_e_ntu_edu_sg/project/diffusers/assets/cond_imgs/ghost.png"
...
video_path = os.path.join("/home/tianxing001_e_ntu_edu_sg/project/diffusers/outputs/", f"{img_name}_full.mp4")
